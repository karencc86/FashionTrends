...
❖Optimize the use of natural resources in production; although there is no strong correlation between environmental impact variables, it is recommended that companies implement programs to reduce water consumption and waste production, as these are key indicators of sustainability that can be optimized in manufacturing processes.
